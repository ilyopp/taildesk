...
window.BC = (function () {
  const DICT = {
    en: {
      ...
      "xf.dropOnDevice": "Drop the files on a device to send them",
      ...
      "rc.waitingTitle": "Authorization request sent",
      "rc.waitingHint": "Waiting for an answer on",
      "rc.cancel": "Cancel",
      "rc.incomingTitle": "Remote control request",
      "rc.incomingSub": "wants to see and control this screen.",
      "rc.screen": "Screen (required)",
      "rc.keyboard": "Keyboard",
      "rc.mouse": "Mouse",
      "rc.accept": "Accept",
      "rc.refuse": "Refuse",
      "rc.mute": "Refuse and ignore for 15 min",
      "rc.waiting": "Waiting for authorization",
      "rc.refused": "Request refused on the other device.",
      "rc.muted": "This device is ignoring requests. Try again in 15 min.",
      "rc.timeout": "No answer in time.",
      "rc.offline": "Unable to reach the other device.",
      "rc.busy": "A session is already running on the other device.",
      "rc.ended": "Session ended",
    ...
    fr: {
      ...
      "xf.dropOnDevice": "Dépose les fichiers sur une machine pour les envoyer",
      ...
      "rc.waitingTitle": "Demande d'autorisation envoyée",
      "rc.waitingHint": "En attente d'une réponse sur",
      "rc.cancel": "Annuler",
      "rc.incomingTitle": "Demande de contrôle à distance",
      "rc.incomingSub": "demande à voir et contrôler cet écran.",
      "rc.screen": "Écran (requis)",
      "rc.keyboard": "Clavier",
      "rc.mouse": "Souris",
      "rc.accept": "Accepter",
      "rc.refuse": "Refuser",
      "rc.mute": "Refuser et ignorer 15 min",
      "rc.waiting": "En attente d'autorisation",
      "rc.refused": "Demande refusée sur l'autre appareil.",
      "rc.muted": "Cet appareil ignore les demandes. Réessaie dans 15 min.",
      "rc.timeout": "Pas de réponse à temps.",
      "rc.offline": "Impossible de joindre l'autre appareil.",
      "rc.busy": "Une session est déjà en cours sur l'autre appareil.",
      "rc.ended": "Session terminée",
