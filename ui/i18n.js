...
window.BC = (function () {
  const DICT = {
    en: {
      ...
      "menu.taildrop": "Send a file (Taildrop)",
      "menu.rdpOpenWin": "Opening Windows Remote Desktop…",
      "menu.rdpOpen": "Opening Remote Desktop…",

      "taildrop.sending": "Sending to {h}…",
      "taildrop.sent": "File sent to {h}",
    ...
    fr: {
      ...
      "menu.taildrop": "Envoyer un fichier (Taildrop)",
      "menu.rdpOpenWin": "Ouverture du Bureau à distance Windows…",
      "menu.rdpOpen": "Ouverture du Bureau à distance…",

      "taildrop.sending": "Envoi vers {h}…",
      "taildrop.sent": "Fichier envoyé à {h}",
